...
A token is how a client can verify if a user is logged in.
- [ ] What steps can you take in your web apps to keep your data secure?
You can use Protected Routes or acquire an SSL cert.
- [ ] Describe how web servers work.
A web server is the code used to manage data storage and retrieval by a computer meant for that specific purpose.
